    ...
    <div className="flex flex-col gap-8">
      <section className="flex flex-col gap-4">
        <SectionHeader
          ...
          description="Start from a template or describe your own. Either way you get the same Bridge manifest, which you can edit afterwards."
        />
          ...
          <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {templates.map((template) => (
              <button
                ...
                className="flex flex-col gap-1 rounded-[var(--radius-sm)] border border-border bg-bg p-3 text-left transition hover:border-border-strong hover:bg-bg-overlay disabled:opacity-50"
              >
      ...
      <section className="flex flex-col gap-4">
        ...
        {agents.length === 0 ? (
          <EmptyState title="No agents yet">
            Create one above — a template is the quickest way to see Bridge work.
          </EmptyState>
        ) : (
