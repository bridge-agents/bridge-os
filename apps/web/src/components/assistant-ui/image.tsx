      ...
      {isMounted &&
        ...
        createPortal(
          <button
            ...
            className="aui-image-zoom-overlay fade-in animate-in fixed inset-0 z-50 flex h-full w-full cursor-zoom-out items-center justify-center border-0 bg-black/80 p-0 duration-200"
            onClick={handleClose}
